...
#	print("StepTime")
	...
	users = [(currentUsers[ip], ix) for ix, ip in enumerate(currentUserIPs) if currentUsers[ip].timeelapsed(currentTimeStamp)>inactivity]
	for u in users:
		output.write(u[0].output())
		del currentUserIPs[u[1]]
